import {
    ...
    MenuItem, Grid, Container, Avatar, Switch
} from "@mui/material";
...
function BookPage() {
    ...
    const columns = [
        ...
        },
        {
            ...
            align:'center',
            headerAlign: 'center',
            renderCell: ({ value, row }) => LanguageData[value ?? 'en'].name,
        },
        {
            field: 'countryIso',
            ...
            align:'center',
            headerAlign: 'center',
            renderCell: ({ value, row }) => value?.map(country => Country[country]),
        },
        {
            field: 'releaseDate',
                    ...
                    <Box>
                        <form onSubmit={formik.handleSubmit}>
                            <Grid container spacing={2} direction="row" alignItems="flex-end">
                                ...
                                <Grid item>
                                    <Button color="secondary" variant="contained" type="button" size="small" onClick={() => { addNewBook() }}>New Book</Button>
                                </Grid>
