...
function UnitTemplatePage() {
    ...
    const fetchunitTemplate = (filter = {}) => {
        ...
        UnitTemplateService.all({ filter }, unitTemplatePage + 1, unitTemplateLimit).then(res => {
    ...
    const handleDelete = (row = null) => {
        if (window.confirm("Are you sure?")) {
            UnitTemplateService.destroy(row._id).then(res => {
...
export default UnitTemplatePage;